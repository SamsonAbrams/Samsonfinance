export default function Contact() {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold text-blue-900 mb-8">Contact Me</h1>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-700 mb-6">
              I'm here to help you with your financial journey. Feel free to reach out through any of the following channels:
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700">samson@financewithsamson.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-700">917-618-2303</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <a 
                  href="https://www.instagram.com/financewithsamson/" 
                  target="_blank" 
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-blue-900">LinkedIn</h3>
                <a 
                  href="https://www.linkedin.com/in/samsonabrams" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="inline-flex items-center text-blue-600 hover:text-blue-700 font-medium hover:underline"
                >
